(function(){
  ...
  var SERVICES = [
    ...
    { id:"recurring", name:"Biweekly Exterior Plan", blurb:"Set it and forget it — Exterior Detail every 2 weeks, with an automatic 10% off every visit for as long as you're on the plan.", icon:'<path d="M35 14a15 15 0 1 0 3 9" stroke="currentColor" stroke-width="2" fill="none" stroke-linecap="round"/><path d="M38 6v9h-9" stroke="currentColor" stroke-width="2" fill="none" stroke-linecap="round" stroke-linejoin="round"/>' }
  ];
